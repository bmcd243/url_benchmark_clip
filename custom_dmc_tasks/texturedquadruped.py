...
def get_model_and_assets():
    ...
    xml = resources.GetResource(os.path.join(task_dir, 'texturedquadruped.xml'))
...
def make_model(floor_size=None, terrain=False, rangefinders=False,
  ...
  xml_string = common.read_model(os.path.join(root_dir, 'custom_dmc_tasks', 'texturedquadruped.xml'))
